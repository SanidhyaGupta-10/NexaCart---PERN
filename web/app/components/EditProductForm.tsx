...
import type { Product, UpdateProductInput } from "@/app/src/types/api.types";

interface EditProductFormProps {
  product: Product;
  isPending: boolean;
  isError: boolean;
  onSubmit: (data: Omit<UpdateProductInput, "id">) => void;
}
...
}: EditProductFormProps) 
{
  ...
  return (
    <div className="max-w-lg mx-auto mb-10">
      <Link href="/profile" className="btn btn-ghost btn-sm gap-1 mb-4 mt-2">
